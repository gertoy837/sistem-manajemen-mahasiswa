                ...
                <div class="flex items-center justify-between px-8 py-4">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-slate-500 text-sm">Ubah data mahasiswa: ${mahasiswa.namaMahasiswa}</p>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <div class="p-8">
                ...
                <div class="max-w-4xl mx-auto">
                    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                        <!-- Form Header -->
                        <div class="px-8 py-6 border-b border-slate-100 bg-gradient-to-r from-blue-500 to-indigo-500">
                            <div class="flex items-center space-x-4">
                                <div class="w-14 h-14 rounded-xl bg-white/20 backdrop-blur flex items-center justify-center">
                                    <i class="fas fa-user-edit text-white text-xl"></i>
                                </div>
                                <div>
                                    <h3 class="text-xl font-bold text-white">Edit Informasi Mahasiswa</h3>
                                    <p class="text-blue-100 text-sm">NIM: ${mahasiswa.nim}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <form action="${pageContext.request.contextPath}/mahasiswa" method="POST" class="p-8">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="nim" name="nim" required value="${mahasiswa.nim}"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="namaMahasiswa" name="namaMahasiswa" required value="${mahasiswa.namaMahasiswa}"
                                           class="w-full px-4 py-3 rounded-xl border border-slate-200 input-focus transition-all text-sm"
                                ...
                                <div>
                                    ...
                                    <input type="email" id="email" name="email" required value="${mahasiswa.email}"
                                           class="w-full px-4 py-3 rounded-xl border border-slate-200 input-focus transition-all text-sm"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="telepon" name="telepon" required value="${mahasiswa.telepon}"
                                           class="w-full px-4 py-3 rounded-xl border border-slate-200 input-focus transition-all text-sm"
                                ...
                                <div>
                                    ...
                                    <select id="jenisKelamin" name="jenisKelamin" required 
                                        ...
                                        <option value="L" ${jenisKelaminStr == 'L' ? 'selected' : ''}>Laki-laki</option>
                                        <option value="P" ${jenisKelaminStr == 'P' ? 'selected' : ''}>Perempuan</option>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <select id="semesterAktif" name="semesterAktif" required 
                                        ...
                                        <c:forEach begin="1" end="14" var="i">
                                            <option value="${i}" ${mahasiswa.semesterAktif == i ? 'selected' : ''}>Semester ${i}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" id="ipk" name="ipk" step="0.01" min="0" max="4" value="${mahasiswa.ipk}"
                                           class="w-full px-4 py-3 rounded-xl border border-slate-200 input-focus transition-all text-sm"
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea id="alamat" name="alamat" rows="3" required 
                                              ...
                                              placeholder="Alamat lengkap mahasiswa">${mahasiswa.alamat}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center justify-end space-x-4 mt-8 pt-6 border-t border-slate-100">
                                ...
                                <button type="submit" 
                                        class="px-6 py-3 rounded-xl bg-gradient-to-r from-blue-500 to-indigo-500 text-white font-medium text-sm shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30 transition-all hover:-translate-y-0.5">
