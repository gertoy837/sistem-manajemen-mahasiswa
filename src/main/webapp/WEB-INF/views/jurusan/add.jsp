...
<head>
    ...
    <title>Tambah Jurusan - Sistem Manajemen Mahasiswa</title>
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-white shadow-sm border-b border-gray-200 px-8 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800">Tambah Jurusan</h2>
                        <p class="text-gray-500 text-sm">Tambahkan jurusan/program studi baru</p>
                    </div>
                </div>
            </header>
