...
<head>
    ...
    <title>Edit Dosen - Sistem Manajemen Mahasiswa</title>
            ...
            <header class="bg-white shadow-sm border-b border-gray-200 px-8 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-500 text-sm">Edit data dosen: ${dosen.namaDosen}</p>
                    </div>
                </div>
            </header>
            ...
            <main class="flex-1 overflow-y-auto p-8">
                <div class="max-w-4xl mx-auto">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
                        <form action="${pageContext.request.contextPath}/dosen/update" method="post">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" id="namaDosen" name="namaDosen" value="${dosen.namaDosen}" required
                                           class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                ...
                                <div>
                                    ...
                                    <select id="idJurusan" name="idJurusan" required
                                        ...
                                        <c:forEach var="jurusan" items="${listJurusan}">
                                            <option value="${jurusan.idJurusan}" ${jurusan.idJurusan == dosen.idJurusan ? 'selected' : ''}>${jurusan.namaJurusan}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="email" id="email" name="email" value="${dosen.email}"
                                           class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="telepon" name="telepon" value="${dosen.telepon}"
                                           class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                ...
                                <div>
                                    ...
                                    <input type="date" id="tanggalLahir" name="tanggalLahir" value="${dosen.tanggalLahir}"
                                           class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                </div>
                                ...
                                <div>
                                    ...
                                    <select id="pendidikanTerakhir" name="pendidikanTerakhir" required
                                        ...
                                        <option value="S1" ${dosen.pendidikanTerakhir == 'S1' ? 'selected' : ''}>S1</option>
                                        <option value="S2" ${dosen.pendidikanTerakhir == 'S2' ? 'selected' : ''}>S2</option>
                                        <option value="S3" ${dosen.pendidikanTerakhir == 'S3' ? 'selected' : ''}>S3</option>
                                    </select>
                                </div>
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <textarea id="alamat" name="alamat" rows="3"
                                              class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                              placeholder="Masukkan alamat lengkap">${dosen.alamat}</textarea>
                                </div>
                            </div>
